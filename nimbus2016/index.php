                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <div class="block wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <section class="cd-intro">
                                <h1 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s" >
                                <span>OUR ALL EVENTS</span><br>
                                <span class="cd-words-wrapper">
                                    <b class="is-visible">THIS NIMBUS</b>
                                    <b>LIST</b>
                                    <b>BELOW</b>
                                </span>
                                </h1>
                                ...
                                <!-- /.slider -->
                                <h2 class="wow fadeInUp animated" data-wow-delay=".6s" >
                                     Below is the list of the events we are organizing this time in Nimbus 2K16.
                                </h2>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-lg-4 col-xs-12">
                            <div class="media wow fadeInUp animated" data-wow-duration="500ms" data-wow-delay="300ms">
                                ...
                                <div class="media-body">
                                    <h3 class="media-heading">Paradox</h4>
                                    <p>Guess it if you can!</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-4 col-xs-12">
                            <div class="media wow fadeInDown animated" data-wow-duration="500ms" data-wow-delay="600ms">
                                ...
                                <div class="media-body">
                                    <h3 class="media-heading">The Game of codes</h4>
                                    <p>Code it right!</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-4 col-xs-12">
                            <div class="media wow fadeInDown animated" data-wow-duration="500ms" data-wow-delay="900ms">
                                ...
                                <div class="media-body">
                                    <h3 class="media-heading">Hunt the code</h4>
                        ...
                        <div class="col-md-4 col-lg-4 col-xs-12">
                            <div class="media wow fadeInDown animated" data-wow-duration="500ms" data-wow-delay="1200ms">
                                ...
                                <div class="media-body">
                                    <h3 class="media-heading">Webbed</h4>
                                    <p>Design the best out of it!</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-4 col-xs-12">
                            <div class="media wow fadeInDown animated" data-wow-duration="500ms" data-wow-delay="1500ms">
                                ...
                                <div class="media-body">
                                    <h3 class="media-heading">BrainBuster</h4>
                                    <p>It can burst your brain!</p>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-4 col-lg-4 col-xs-12">
                            <div class="media wow fadeInDown animated" data-wow-duration="500ms" data-wow-delay="1500ms">
                                ...
                                <div class="media-body">
                                    <h3 class="media-heading">CodeSwap</h4>
                                    <p>Write and Switch, the loop begins!</p>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-4 col-lg-4 col-xs-12">
                            <div class="media wow fadeInDown animated" data-wow-duration="500ms" data-wow-delay="1500ms">
                                ...
                                <div class="media-body">
                                    <h3 class="media-heading">CodeSense</h4>
                                    <p>The all new senses!</p>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="col-md-4 col-lg-4 col-xs-12">
                            <div class="media wow fadeInDown animated" data-wow-duration="500ms" data-wow-delay="1500ms">
                                ...
                                <div class="media-body">
                                    <h3 class="media-heading">HackHunt</h4>
                                    <p>Hack and hunt!</p>
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="media-body">
                                    <h3 class="media-heading">Trolled</h4>
                                    <p>Keep trolling others!</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-lg-4 col-xs-12">
                            <div class="media wow fadeInDown animated" data-wow-duration="500ms" data-wow-delay="1800ms">
                                ...
                                <div class="media-body">
                                    <h3 class="media-heading">Exeplore</h4>
                                    <p>Keep exeploring!</p>
                                </div>
                            </div>
                        </div>
